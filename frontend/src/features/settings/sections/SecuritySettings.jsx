  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-8 border-b border-outline-variant/30 pb-4">
        <div>
          <h2 className="text-2xl font-geist font-bold text-on-surface">Security Configuration</h2>
          <p className="text-sm text-on-surface-variant mt-1">Manage security preferences and policies.</p>
        </div>
      </div>
